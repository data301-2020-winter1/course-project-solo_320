...
def load_and_process(redwine_path, whitewine_path):
    ...
    redwine = (df
           ...
           .reindex(columns = ['wine_type', 'citric acid', 'fixed acidity', 'volatile acidity', 'residual sugar', 'chlorides', 'sulphates', 'free sulfur dioxide', 'total sulfur dioxide', 'density', 'pH', 'alcohol', 'quality', 'quality_label'])
          )
